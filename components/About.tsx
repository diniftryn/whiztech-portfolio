...
export default function About() {
  return (
    <section id="about" className="w-full border border-t-black flex">
      <div className="flex-1 bg-lime-100 flex flex-col justify-center items-center">
      ...
      <div className="bg-blue-200 border border-l-black">
